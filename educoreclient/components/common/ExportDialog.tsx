    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title} size="lg">
      <div className="space-y-6 p-6">
        ...
        <div className="text-sm text-slate-600 mb-2">
          Download all academic years as a CSV or Excel file. Exported data will
          match your current filters and search results. Use this for backups,
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 flex items-center gap-2">
          ...
          <span className="text-xs text-green-800">
            Tip: Use search to filter before export for specific data sets. File
            will be named with today&apos;s date.
          </span>
        </div>
        {/* Actions */}
