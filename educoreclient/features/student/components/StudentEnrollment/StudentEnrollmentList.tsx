  ...
  return (
    <div className="flex items-center justify-end">
      ...
      <div className="relative inline-block text-left">
        ...
        >
          <button
            className="flex items-center w-full px-4 py-2 text-sm text-blue-700 hover:bg-blue-50 gap-2"
            onClick={() => {
              onBulkUpdate();
              menuRef.current?.classList.add("hidden");
            }}
...
const StudentEnrollmentList: React.FC = () => {
  ...
  const filterFns: {
    [key: string]: (cell: string, filterValue: string) => boolean;
  } = {
  ...
  const active = enrollments.filter(
    (s: any) => s.StudentStatus === "Active"
  ).length;
  const boys = enrollments.filter(
    (s: any) => (s.Gender || "").toLowerCase() === "male"
  ).length;
  const girls = enrollments.filter(
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="bg-white rounded-lg border border-emerald-200 p-3 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="bg-white rounded-lg border border-blue-200 p-3 shadow-sm hover:shadow-md transition-shadow">
          <p className="text-xs font-medium text-blue-600 uppercase tracking-wide">
            Boys
          </p>
          <p className="text-xl font-semibold text-blue-700 mt-1">{boys}</p>
        </div>
        <div className="bg-white rounded-lg border border-pink-200 p-3 shadow-sm hover:shadow-md transition-shadow">
          <p className="text-xs font-medium text-pink-600 uppercase tracking-wide">
            Girls
          </p>
          <p className="text-xl font-semibold text-pink-700 mt-1">{girls}</p>
        </div>
        <div className="bg-white rounded-lg border border-amber-200 p-3 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="bg-white rounded-lg border border-indigo-200 p-3 shadow-sm hover:shadow-md transition-shadow">
        ...
        <Table className="w-full">
          <TableHeader>
            <TableRow className="bg-slate-50 border-b border-slate-200">
              ...
              <TableHead className="text-slate-700 font-medium text-xs w-10 py-2 px-3">
                {bulkMode && (
                  <input
                    type="checkbox"
              ...
              {/* Photo column */}
              <TableHead className="text-slate-700 font-medium text-xs py-2 px-3 w-16">
                Photo
              </TableHead>
              {/* Name */}
              <TableHead
                className="text-slate-700 font-medium text-xs py-2 px-3 cursor-pointer select-none hover:text-slate-900"
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      column="Name"
                      filter={
                        columnFilters["Name"] || { type: "contains", value: "" }
                      }
                      onApply={(type, value) =>
                        handleColumnFilterApply("Name", type, value)
                      }
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      ...
                      onApply={(type, value) =>
                        handleColumnFilterApply("RollNumber", type, value)
                      }
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      ...
                      onApply={(type, value) =>
                        handleColumnFilterApply("Gender", type, value)
                      }
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      ...
                      onApply={(type, value) =>
                        handleColumnFilterApply("Mobile", type, value)
                      }
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      ...
                      filter={
                        columnFilters["AdmissionNumber"] || {
                          type: "contains",
                          value: "",
                        }
                      }
                      onApply={(type, value) =>
                        handleColumnFilterApply("AdmissionNumber", type, value)
                      }
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      ...
                      filter={
                        columnFilters["AdmissionDate"] || {
                          type: "contains",
                          value: "",
                        }
                      }
                      onApply={(type, value) =>
                        handleColumnFilterApply("AdmissionDate", type, value)
                      }
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      column="Stream"
                      filter={
                        columnFilters["Stream"] || {
                          type: "contains",
                          value: "",
                        }
                      }
                      onApply={(type, value) =>
                        handleColumnFilterApply("Stream", type, value)
                      }
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="ml-1">
                    <ColumnFilterPopover
                      ...
                      onApply={(type, value) =>
                        handleColumnFilterApply("Medium", type, value)
                      }
              ...
              <TableHead className="text-slate-700 font-medium text-xs py-2 px-3 text-right w-24">
          ...
          <TableBody>
            {loading ? (
              ...
              sorted.map((row: any, index: number) => (
                <TableRow
                  key={row.Id ?? row.RollNumber ?? index}
                ...
                >
                  ...
                  <TableCell className="py-2 px-3">
                    {bulkMode && (
                      <input
                        ...
                        onChange={() =>
                          toggleItem(row.Id ?? row.RollNumber ?? "")
                        }
                        className="accent-blue-600"
                        title="Select row"
                      />
                  ...
                  <TableCell className="py-2 px-3 whitespace-nowrap text-xs font-medium text-slate-900">
                    {row.Name}
                  </TableCell>
                  <TableCell className="py-2 px-3 whitespace-nowrap text-xs text-slate-600">
                    {row.RollNumber}
                  </TableCell>
                  <TableCell className="py-2 px-3 whitespace-nowrap text-xs text-slate-600">
                    {row.Gender}
                  ...
                  <TableCell className="py-2 px-3 whitespace-nowrap text-xs text-right">
                    <RowActionMenu
          ...
          <TableFooter>
            <TableRow className="bg-slate-50">
              <TableCell
                colSpan={14}
                className="px-3 py-2 text-xs text-slate-700 bg-slate-50"
              >
                {totalCount > 0 && (
                  <PaginationControls
                    pageIndex={pageIndex}
